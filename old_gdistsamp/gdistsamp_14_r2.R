...
null14r2 = gdistsamp(lambdaformula = ~1, 
                     phiformula = ~1, 
                     pformula = ~ 1,
                     data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")
...
reg14r2d = gdistsamp(lambdaformula = ~region-1, 
                     phiformula = ~1, 
                     pformula = ~short-1,
                     data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

area14r2d = gdistsamp(lambdaformula = ~area-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

reg_w14r2d =gdistsamp(lambdaformula = ~region+water-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short14r2d =gdistsamp(lambdaformula = ~short-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short_w14r2d =gdistsamp(lambdaformula = ~short+water-1, 
                        phiformula = ~1, 
                        pformula = ~short- 1,
                        data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

global14r2d =gdistsamp(lambdaformula = ~region+water+area+short-1, 
                       phiformula = ~1, 
                       pformula = ~short- 1,
                       data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")


list14r2  = fitList(null14r2, global14r2, short_w14r2, short14r2,reg_w14r2,area14r2,reg14r2, global14r2d, short_w14r2d, short14r2d,reg_w14r2d,area14r2d,reg14r2d)
