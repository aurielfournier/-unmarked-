...
model14r1$null14r1 = gdistsamp(lambdaformula = ~1, 
                     phiformula = ~1, 
                     pformula = ~ 1,
                     data = umf14r1, keyfun = "hazard", mixture="NB",se = T, output="abund")
...
model14r1$reg_treat14r1 = gdistsamp(lambdaformula = ~region+treat-1, 
                          phiformula = ~1, 
                          pformula = ~ 1,
                          data = umf14r1, keyfun = "hazard", mixture="NB",se = T, output="abund")

model14r1$treat14r1 =gdistsamp(lambdaformula = ~treat-1, 
                     phiformula = ~1, 
                     pformula = ~ 1,
                     data = umf14r1, keyfun = "hazard", mixture="NB",se = T, output="abund")
