...
null14r1 = gdistsamp(lambdaformula = ~1, 
                     phiformula = ~1, 
                     pformula = ~ 1,
                     data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")
...
reg14r1d = gdistsamp(lambdaformula = ~region-1, 
                     phiformula = ~1, 
                     pformula = ~short-1,
                     data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

area14r1d = gdistsamp(lambdaformula = ~area-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

reg_w14r1d =gdistsamp(lambdaformula = ~region+averagewater_1-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short14r1d =gdistsamp(lambdaformula = ~short-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short_w14r1d =gdistsamp(lambdaformula = ~short+averagewater_1-1, 
                        phiformula = ~1, 
                        pformula = ~short- 1,
                        data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

global14r1d =gdistsamp(lambdaformula = ~region+averagewater_1+area+short-1, 
                       phiformula = ~1, 
                       pformula = ~short- 1,
                       data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")


list14r1  = fitList(null14r1, global14r1, short_w14r1, short14r1,reg_w14r1,area14r1,reg14r1, global14r1d, short_w14r1d, short14r1d,reg_w14r1d,area14r1d,reg14r1d)
