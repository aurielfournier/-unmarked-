...
```
```{r}
model14r1$global14r1 =gdistsamp(lambdaformula = ~region+averagewater_1+short+region*averagewater_1+averagewater_1*short+region*short+region*averagewater_1*short-1, 
                      phiformula = ~1, 
                      pformula = ~ 1,
                      data = umf14r1, keyfun = "hazard", mixture="P",se = T, output="abund")
