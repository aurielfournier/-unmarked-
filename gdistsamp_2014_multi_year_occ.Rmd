...
```{r}
model$global <- gdistsamp(lambdaformula = ~scale_pe+scale_short+scale_water+scale_averagewater+fs+region+scale_int+scale_millet_+scale_annual_smartweed_+scale_perennial_smartweed_, 
                      phiformula = ~1, 
                      pformula = ~ 1,
                      data = umf, keyfun = "hazard", mixture="NB",se = T, output="abund")
```
