...
reg_w14r2d =gdistsamp(lambdaformula = ~region+averagewater_2-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")
...
short_w14r2d =gdistsamp(lambdaformula = ~short+averagewater_2-1, 
                        phiformula = ~1, 
                        pformula = ~short- 1,
                        data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

global14r2d =gdistsamp(lambdaformula = ~region+averagewater_2+area+short-1, 
                       phiformula = ~1, 
                       pformula = ~short- 1,
                       data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")
