...
```
```{r}
model14r2$global14r2 =gdistsamp(lambdaformula = ~region+averagewater_2+short+region*averagewater_2+averagewater_2*short+region*short+region*averagewater_2*short-1, 
                      phiformula = ~1, 
                      pformula = ~ 1,
                      data = umf14r2, keyfun = "hazard", mixture="P",se = T, output="abund")
