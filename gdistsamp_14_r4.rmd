...
short_pe14r4 <- gdistsamp(lambdaformula = ~short+pe-1, 
                       phiformula = ~1, 
                       pformula = ~ 1,
                       data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")

short_pe14r4d <- gdistsamp(lambdaformula = ~short+pe-1, 
                       phiformula = ~1, 
                       pformula = ~ short-1,
                       data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")
...
reg14r4d = gdistsamp(lambdaformula = ~region-1, 
                     phiformula = ~1, 
                     pformula = ~short-1,
                     data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")

area14r4d = gdistsamp(lambdaformula = ~area-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")

reg_w14r4d =gdistsamp(lambdaformula = ~region+averagewater_4-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")

short14r4d =gdistsamp(lambdaformula = ~short-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")

short_w14r4d =gdistsamp(lambdaformula = ~short+averagewater_4-1, 
                        phiformula = ~1, 
                        pformula = ~short- 1,
                        data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")

global14r4d =gdistsamp(lambdaformula = ~region+averagewater_4+area+short-1, 
                       phiformula = ~1, 
                       pformula = ~short- 1,
                       data = umf14r4, keyfun = "hazard", mixture="NB",se = T, output="abund")


list14r4  = fitList(null14r4, global14r4, short_w14r4, treat14r4, reg_treat14r4,short_pe14r4d, short_pe14r4, short14r4,reg_w14r4,area14r4,reg14r4, global14r4d, short_w14r4d, short14r4d,reg_w14r4d,area14r4d,reg14r4d)
