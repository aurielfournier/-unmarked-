...
```
```{r}
model14r4$global14r4 =gdistsamp(lambdaformula = ~region+averagewater_4+short+region*averagewater_4+averagewater_4*short+region*short+region*averagewater_4*short-1, 
                      phiformula = ~1, 
                      pformula = ~ 1,
                      data = umf14r4, keyfun = "hazard", mixture="P",se = T, output="abund")
