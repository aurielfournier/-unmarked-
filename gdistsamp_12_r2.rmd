...
null12r2 = gdistsamp(lambdaformula = ~1, 
                     phiformula = ~1, 
                     pformula = ~ 1,
                     data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")
...
reg12r2d = gdistsamp(lambdaformula = ~region-1, 
                     phiformula = ~1, 
                     pformula = ~short-1,
                     data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

area12r2d = gdistsamp(lambdaformula = ~area-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

reg_w12r2d =gdistsamp(lambdaformula = ~region+water-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short12r2d =gdistsamp(lambdaformula = ~short-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short_w12r2d =gdistsamp(lambdaformula = ~short+water-1, 
                        phiformula = ~1, 
                        pformula = ~short- 1,
                        data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

global12r2d =gdistsamp(lambdaformula = ~region+water+area+short-1, 
                       phiformula = ~1, 
                       pformula = ~short- 1,
                       data = umf12r2, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")


list12r2  = fitList(null12r2, global12r2, short_w12r2, short12r2,reg_w12r2,area12r2,reg12r2, global12r2d, short_w12r2d, short12r2d,reg_w12r2d,area12r2d,reg12r2d)
