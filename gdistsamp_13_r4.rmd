...
reg13r4d = gdistsamp(lambdaformula = ~region-1, 
                     phiformula = ~1, 
                     pformula = ~short-1,
                     data = umf13r4, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

area13r4d = gdistsamp(lambdaformula = ~area-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf13r4, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

reg_w13r4d =gdistsamp(lambdaformula = ~region+water-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf13r4, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short13r4d =gdistsamp(lambdaformula = ~short-1, 
                      phiformula = ~1, 
                      pformula = ~short- 1,
                      data = umf13r4, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

short_w13r4d =gdistsamp(lambdaformula = ~short+water-1, 
                        phiformula = ~1, 
                        pformula = ~short- 1,
                        data = umf13r4, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")

global13r4d =gdistsamp(lambdaformula = ~region+water+area+short-1, 
                       phiformula = ~1, 
                       pformula = ~short- 1,
                       data = umf13r4, keyfun = "hazard", mixture="P",se = T, output="density",unitsOut="ha")


list13r4  = fitList(null13r4, global13r4, short_w13r4, short13r4,reg_w13r4,area13r4,reg13r4, global13r4d, short_w13r4d, short13r4d,reg_w13r4d,area13r4d,reg13r4d)
