...
sora13r4 <- sora13r4[sora13r4$impound!="m3",]
cov13r4 <- cov13r4[cov13r4$impound!="m3",]

sora13r4 <- sora13r4[order(sora13r4$impound),]
cov13r4 <- cov13r4[order(cov13r4$impound),]
sora13r4 <- sora13r4[,2:73]
