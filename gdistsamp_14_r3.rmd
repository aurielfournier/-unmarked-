...
```
```{r}
model14r3$global14r3 =gdistsamp(lambdaformula = ~region+averagewater_3+short+region*averagewater_3+averagewater_3*short+region*short+region*averagewater_3*short-1, 
                      phiformula = ~1, 
                      pformula = ~ 1,
                      data = umf14r3, keyfun = "hazard", mixture="P",se = T, output="abund")
